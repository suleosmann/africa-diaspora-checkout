<template>
  <div class="relative bg-[#3D2817] h-[65vh] flex flex-col">
    <div style="background-image: url('/belowheader.png');" class="h-20 flex-shrink-0"></div>
    
    <!-- Content -->
    <div class="relative z-10 flex-1 flex items-center">
      <div class="w-full">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-0 items-center h-full">
          
          <!-- Left Side - Content -->
          <div class="lg:col-span-8 pl-6 pr-12 py-6 space-y-4">
            <!-- Heading -->
            <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-[#FFDA9E] leading-tight">
              Africa Is building the Largest Smart Economic Corridor in the World
            </h1>
            ...
            <div>
              <a 
                href="/register"
                class="inline-block bg-[#FFDA9E] hover:bg-[#ffd180] text-[#3D2817] font-bold px-24 py-3 rounded-lg text-base transition-all"
              >
                JOIN ADEN
              </a>
            </div>
